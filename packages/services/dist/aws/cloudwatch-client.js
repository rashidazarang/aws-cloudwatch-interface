...
export class CloudWatchService {
    ...
    constructor(options) {
        ...
        if (client) {
            ...
            this.client = new CloudWatchLogsClient(clientOptions);
        }
        this.sleep = options?.sleepFn ?? defaultSleep;
    }
    async listLogGroups(nextToken) {
...
export function createCloudWatchService(config) {
    return new CloudWatchService(config);
}
//# sourceMappingURL=cloudwatch-client.js.map